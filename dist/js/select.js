...
var SelectHeader = /** @class */ (function (_super) {
    ...
    SelectHeader.prototype.build = function () {
        this.element.addClass("".concat(tonada_shared_1.PREFIX, "-select-header"));
    };
...
window.TonadaSelect = __webpack_exports__;
/******/ })()
;
